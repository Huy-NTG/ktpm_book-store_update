...
import QuanLyBanSach.DAO.KhachHangDAO;
...
public class KhachHangBUS {
    ...
    public boolean themKhachHang1(String ma, String ho, String ten, String gioiTinh) {
        if (ten.trim().equals("") && ho.trim().equals("") ) {
            new MyDialog("Không được để trống họ và tên!", MyDialog.ERROR_DIALOG);
            return false;
        }
        if (gioiTinh.equals("Chọn giới tính")) {
            new MyDialog("Vui lòng chọn giới tính khách hàng!", MyDialog.ERROR_DIALOG);
            return false;
        }
