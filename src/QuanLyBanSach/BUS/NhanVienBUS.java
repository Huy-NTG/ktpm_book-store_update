...
import QuanLyBanSach.DAO.NhanVienDAO;
...
public class NhanVienBUS {
    ...
    public boolean themNhanVien(String ho, String ten, String gioiTinh, String chucVu) {
    	if(ten.equals("")||chucVu.equals("")){
            new MyDialog("Họ tên và chức vụ không được để trống!", MyDialog.ERROR_DIALOG);
            return false;
        }
        ho = ho.trim();
        ten = ten.trim();
    ...
    public boolean themNhanVien1(String ma,String ho, String ten, String gioiTinh, String chucVu) {
