...
public class ThongKeGUI extends JFrame {
	...
	public ThongKeGUI() {
		...
		lbl_tongChi.setFont(new Font("Tahoma", Font.BOLD, 35));
                lbl_tongChi.setHorizontalAlignment(SwingConstants.CENTER);
		...
		pn_hienthi.setBounds(10, 320, 1166, 377);
		pn_hienthi.setVisible(false);
		
		pn_hienthi1 = new ThongKeThang();
		pn_hienthi1.setBounds(10, 336, 1166, 377);
		...
		cbx_nam.setModel(new DefaultComboBoxModel(new String[] {"2018", "2019", "2020", "2021", "2022","2023","2024","2025","2026","2027"}));
		cbx_nam.setSelectedIndex(6);
		...
		btn_bieudo.setBounds(982, 290, 117, 21);
		...
		btn_menu.setBounds(450, 720, 216, 33);
