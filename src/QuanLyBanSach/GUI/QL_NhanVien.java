...
import QuanLyBanSach.BUS.NhanVienBUS;
import QuanLyBanSach.BUS.PhanQuyenBUS;
import QuanLyBanSach.BUS.TaiKhoanBUS;
...
public class QL_NhanVien extends JFrame {
	 ...
	 * Create the frame.
	 */
	public QL_NhanVien(String chucvu) {
		...
		btnNewButton_5.setBounds(60, 58, 103, 21);
		...
		btnNewButton_6.setBounds(180, 58, 109, 21);
		panel_4.add(btnNewButton_6);
                
                JButton btnNewButton_7 = new JButton("Xuất Pdf");
		btnNewButton_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				xuLyXuatPdf();
			}
		});
		btnNewButton_7.setBounds(305, 58, 109, 21);
	...
	private void themNV1() {
		...
		boolean flag = NVBUS.themNhanVien1(txt_maNV.getText(), txt_Ho.getText(), txt_ten.getText(), gioitinh, chucvu);
		if (flag) {
			NVBUS.docDanhSach();
			loadingNhanVien();
		}
		...
		boolean flag = NVBUS.themNhanVien(txt_Ho.getText(), txt_ten.getText(), gioitinh, chucvu);
		if (flag) {
			NVBUS.docDanhSach();
			loadingNhanVien();
		}
	...
	private void xuLyXuatExcel() {
		...
		XuLyFileExcel xuatExcel = new XuLyFileExcel();
		xuatExcel.xuatPDF(tbl_nhanvien,"Danh sách nhân viên");
	}
