...
import QuanLyBanSach.BUS.ThongKeBUS;
...
public class ThongKeQuy extends JPanel {
	...
	public ThongKeQuy() {
		...
		pn_quy.setBounds(33, 10, 983, 350);
                pn_quy.setBackground(new java.awt.Color(255, 255, 255));
		add(pn_quy);
		...
		textField.setBounds(206, 32, 111, 66);//98
		...
		textField_1.setBounds(316, 32, 131, 66);
		...
		textField_2.setBounds(446, 32, 145, 66);
		...
		textField_3.setBounds(591, 32, 138, 66);
		...
		textField_4.setBounds(729, 32, 131, 66);
		...
		textField_5.setBounds(206, 98, 111, 66);
		...
		txt_thu1.setBounds(316, 98, 131, 66);
		pn_quy.add(txt_thu1);
		...
		txt_thu2.setBounds(446, 98, 145, 66);
		pn_quy.add(txt_thu2);
		...
		txt_thu3.setBounds(591, 98, 138, 66);
		pn_quy.add(txt_thu3);
		...
		txt_thu4.setBounds(729, 98, 131, 66);
		pn_quy.add(txt_thu4);
		...
		textField_10.setBounds(206, 206, 111, 66);
		...
		textField_11.setBounds(316, 206, 131, 66);
		...
		textField_12.setBounds(446, 206, 145, 66);
		...
		textField_13.setBounds(591, 206, 138, 66);
		...
		textField_14.setBounds(729, 206, 131, 66);
		...
		textField_15.setBounds(206, 271, 111, 66);
		...
		txt_chi1.setBounds(316, 271, 131, 66);
		pn_quy.add(txt_chi1);
		...
		txt_chi2.setBounds(446, 271, 145, 66);
		pn_quy.add(txt_chi2);
		...
		txt_chi3.setBounds(591, 271, 138, 66);
		pn_quy.add(txt_chi3);
		...
		txt_chi4.setBounds(729, 271, 131, 66);
		pn_quy.add(txt_chi4);
		
		JLabel lblNewLabel_3 = new JLabel("Thu");
		lblNewLabel_3.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel_3.setBounds(34, 68, 104, 45);
		...
		lblNewLabel_3_1.setBounds(34, 227, 104, 45);
